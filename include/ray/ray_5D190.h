...
void set_air_speed(u8 mainEtat, u8 subEtat, s16 param_3, u8 param_4);
...
int RAY_BALANCE_ANIM(s16 param_1);
void abs_sinus_cosinus(s16 param_1, s16 *param_2, s16 *param_3);
