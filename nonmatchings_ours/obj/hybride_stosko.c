...
void doSTOSKOcommand(Obj *obj)
{
    ...
    scrollLocked = 1;
    temp_a1 = obj->main_etat;
    temp_a2 = obj->sub_etat;
    temp_v1 = (temp_a1 << 8) + temp_a2;
    if (temp_v1 == 6)
    {
        goto block_52;
    }
...
block_30:
    ...
    if (
        __builtin_abs(
            (s16) (((ray.offset_by + (u16) ray.y_pos) - (u16) obj->y_pos) - obj->offset_by)
        ) < 0x30
    )
    {
        goto block_35;
    }
    if ((u8) obj->anim_frame < 0xAU)
    {
        goto block_37;
    }
block_35:
...
block_37:
    ...
    return;
block_38:
    if (!(obj->eta[temp_a1][temp_a2].flags & 0x10))
    {
        goto block_41;
    }
    if (obj->anim_frame == 0)
...
block_45:
    temp_a2_2 = &level.objects[obj->field24_0x3e];
    if (temp_a2_2->speed_x <= 0)
    {
        goto block_55;
    }
    if (temp_a2_2->x_pos < obj->x_pos)
    {
        goto block_55;
    }
    obj->field24_0x3e = -1;
