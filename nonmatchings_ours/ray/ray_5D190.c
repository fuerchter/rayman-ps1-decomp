...
loop_4:
        if (var_s1->flags & 0x10000)
        {
            if (var_s1->id != param_2)
            {
                ...
                {
                    var_a0 = instantSpeed(var_s1->speed_y, var_s0);
                }
                else
                {
                    var_a0 = (u16) var_s1->speed_y;
                }
                ...
                temp_v1 = var_s1->type;
                if ((temp_v1 == 0x6D) || (temp_v1 == 0xF1) || (temp_v1 == 0xB3))
                {
                    var_a0_2 += 8;
                }
                    ...
                    if (!(((u8) block_flags[calc_typ_trav(&ray, 2U) & 0xFF] >> 4) & 1))
                    {
                        ...
                        if (ray.main_etat == 2)
                        {
                            ...
                            case 0xa0:
                                ...
                                break;
                            case 0x1:
                                /*if ((num_world != temp_v1_2) && (var_a0_3 = 0x00F2, (num_world != 4)))
                                {
                        ...
                        case 0x86:
                        case 0xA7:
                            if ((var_s1->main_etat == 0) && (var_s1->sub_etat == 0x0D))
                            {
                        ...
                        case 0x83:
                            ...
                            break; /* TODO: continue, PERM_IGNORE for bad switch */
                        case 0x56:
                        ...
                        case 0xA9:
                            ...
                            break;
                        case 0x8A:
                            if ((var_s1->main_etat == 0) && (var_s1->sub_etat == 0x0A))
                            {
                                var_a1_2 = 1;
                                skipToLabel(var_s1, var_a1_2, 1);
                            }
                        ...
                        case 0x9A:
                            ...
                            break;
                        case 0x9B:
                            if ((var_s1->main_etat == 0) && (var_s1->sub_etat == 0x0F))
                            {
                                var_a1_2 = 1;
                                skipToLabel(var_s1, var_a1_2, 1);
                            }
                            break;
                        case 0x31:
                            if ((var_s1->main_etat == 0) && (var_s1->sub_etat == 0))
                            {
                                var_a1_2 = 0;
                                skipToLabel(var_s1, var_a1_2, 1);
                            }
                        ...
                        case 0xCF:
                            if ((var_s1->main_etat != 0) || (var_s1->sub_etat != 1))
                            {
                                ...
                                ray.field20_0x36 = -1U;
                                ray.speed_x = 1;
                                PS1_SetSauveRayEvts(0xFFFEFFFF);
                                RayEvts.flags0 = 1;
                                RayEvts.flags1 = 0U;
                            }
                            break;
                        case 0x43:
                            if ((var_s1->main_etat == 0) && (var_s1->sub_etat == 2))
                            {
...
block_121:
            var_s0 = var_s0 + 1;
            var_s1 = &level.objects[actobj.objects[var_s0]];
            if (var_s0 >= actobj.num_active_objects)
            {
                goto block_122;
            }
            goto loop_4;
...
block_121:
    var_s0 = var_s0 + 1;
    var_s1 = &level.objects[new_var->objects[var_s0]];
    if (var_s0 < new_var->num_active_objects)
    {
        goto loop_4;
    }
block_122:
