...
#hardcoded pointers: the address 0x8005866C (main(), loading_794DC.c, data/loading_A0338 e.g.), FUN_80132864 (unused), data/loading_AA6EC, FUN_8019fb84, loading_tex.c (??? i can't tell)
