...
void FUN_8012da14(void)
{
    ...
    (&PS1_Display1 + 1)->polygons[0].u0 = 0;
    (&PS1_Display1 + 1)->polygons[0].v0 = 0;
    (&PS1_Display1 + 1)->polygons[0].u1 = 128;
    (&PS1_Display1 + 1)->polygons[0].v1 = 0;
    (&PS1_Display1 + 1)->polygons[0].u2 = 0;
    (&PS1_Display1 + 1)->polygons[0].v2 = 240 - 1;
    (&PS1_Display1 + 1)->polygons[0].u3 = 128;
    (&PS1_Display1 + 1)->polygons[0].v3 = 240 - 1;
    ...
    (&PS1_Display1 + 1)->polygons[1].u0 = 0;
    (&PS1_Display1 + 1)->polygons[1].v0 = 0;
    (&PS1_Display1 + 1)->polygons[1].u1 = 192;
    (&PS1_Display1 + 1)->polygons[1].v1 = 0;
    (&PS1_Display1 + 1)->polygons[1].u2 = 0;
    (&PS1_Display1 + 1)->polygons[1].v2 = 240 - 1;
    (&PS1_Display1 + 1)->polygons[1].u3 = 192;
    (&PS1_Display1 + 1)->polygons[1].v3 = 240 - 1;
    ...
    (&PS1_Display1 + 1)->polygons[0].tpage = GetTPage(2, 1, tpage_pos[0].vx, tpage_pos[0].vy);
    (&PS1_Display1 + 1)->polygons[1].tpage = GetTPage(2, 1, tpage_pos[0].vx + 128, tpage_pos[0].vy);
    D_801F56B8.vz = 0; D_801F56B8.vy = 0; D_801F56B8.vx = 0;
    D_801F57D0.vy = 0; D_801F57D0.vx = 0; D_801F57D0.vz = 1024;
    D_801F6390 = 0;
