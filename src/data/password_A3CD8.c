...
PasswordTables PS1_PasswordTables =
{
    .xor_table = { 0x18, 0x08, 0x12, 0x0A, 0x06, 0x16, 0x04, 0x1C, 0x0C, 0x14 },
    .verification_table = { 0x02, 0x03, 0x05, 0x07, 0x11, 0x02, 0x03, 0x05, 0x07, 0x11 },
    .display_table = {
